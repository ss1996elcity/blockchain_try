...
var mnemonic = "car oil small control damp verify thing ship frost kiwi bring orient";
...
module.exports = {
  ...
  networks: {
    ...
    //
     development: {
      host: "46.72.127.251", //"127.0.0.1"     // Localhost (default: none)
     ...
     live: {
    	...
    	from: "0x1260f974874cbb2c5a284d2a1625fc1e7f5d33b3",        // Account to send txs from (default: accounts[0])
    	websocket: true
     },
     rinkeby: {
      provider: function() { 
